...
public class FilmeRepository {
	...
	private FilmeRepository() {
		...
		filmes.put(2l, new FilmeModel(2l, "300", 2006, 18, "1h 57min", "Ação e drama", "Zack Snyder",
				...
				"https://www.guiadasemana.com.br/contentFiles/system/pictures/2013/4/71363/original/300.jpg"));
		...
		filmes.put(3l, new FilmeModel(3l, "Machete", 2010, 18, "1h 45min", "Ação, Crime e suspense",
				...
				"https://br.web.img3.acsta.net/pictures/17/10/04/19/01/4966397.jpg"));
		filmes.put(4l, new FilmeModel(4l, "Kimi no na wa", 2016, 0, "1h 46min", "Animação, Drama e fantasia",
				...
				"https://upload.wikimedia.org/wikipedia/pt/6/6f/Machete_poster.jpg"));
		...
		filmes.put(7l, new FilmeModel(7l, "Marley & Eu", 2008, 0, "1h 51min", "Comédia, drama e família",
				...
				"https://a-static.mlcdn.com.br/618x463/dvd-marley-e-eu-jennifer-aniston-fox/universocultural/1678014737/6f4f16f3b54356a82cfe11d6b117b525.jpg"));
		filmes.put(8l, new FilmeModel(8l, "Star Trek", 2009, 12, "2h 7min", "Ação, aventura e sci-fi", "J.J. Abrams",
				...
				"https://br.web.img3.acsta.net/medias/nmedia/18/90/69/66/20108900.jpg"));
